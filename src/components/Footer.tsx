    ...
    <footer className="bg-primary-dark text-primary-foreground py-12">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start space-x-2">
                ...
                <a href="mailto:Allyourclaimsneeds.com" className="text-primary-foreground/80 hover:text-primary-foreground">
        ...
        <div className="border-t border-primary-foreground/20 pt-8 text-center text-sm text-primary-foreground/60">
          <p>
            &copy; {new Date().getFullYear()} Allyourclaimsneeds. All rights reserved. Licensed Public Adjusters.
          </p>
        </div>
      </div>
    </footer>
